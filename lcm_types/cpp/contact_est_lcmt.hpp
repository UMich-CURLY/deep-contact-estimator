...
#ifndef __contact_est_lcmt_hpp__
#define __contact_est_lcmt_hpp__
...
int contact_est_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int contact_est_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int contact_est_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t contact_est_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* contact_est_lcmt::getTypeName()
{
    return "contact_est_lcmt";
}

int contact_est_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int contact_est_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int contact_est_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t contact_est_lcmt::_computeHash(const __lcm_hash_ptr *)
{
