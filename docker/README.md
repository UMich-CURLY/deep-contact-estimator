## r0bert/orbslam3
This docker file sets up the environment for ORBSLAM3. It aims at installing all non-conflicting related softwares, and encourages download-and-run.


### How to build the docker image from `Dockerfile`?

To build the docker image, run `docker build --tag r0bert/orbslam3_modified . `
