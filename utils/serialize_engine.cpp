...
//! \brief  The OnnxToTensorRT class implements the ONNX Contact Estimtor sample
//!
...
//!
//! \details This function creates the Onnx Contact Estimtor network by parsing the Onnx model and builds
//!          the engine that will be used to run Contact Estimtor (mEngine)
//!
...
//! \brief Reads the input and stores the result in a managed buffer
//!
bool OnnxToTensorRT::processInput(const samplesCommon::BufferManager& buffers)
{   
